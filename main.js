...
const { handleGalaxys5Command } = require('./commands/galaxys5');
const { handleIphone14promaxCommand } = require('./commands/iphone14promax');
const { handleIphone12proCommand } = require('./commands/iphone12pro');
const { handleIphoneXCommand } = require('./commands/iphoneX');
const { handleIphone6plusCommand } = require('./commands/iphone6plus');
const { handleIphone6Command } = require('./commands/iphone6');
const { handleIphone5Command } = require('./commands/iphone5');
const { handleMaxageCommand } = require('./commands/maxage');
const { addCommandReaction, handleAreactCommand } = require('./lib/reactions');
const { goodnightCommand } = require('./commands/goodnight');
const { shayariCommand } = require('./commands/shayari');
const { rosedayCommand } = require('./commands/roseday');
const imagineCommand = require('./commands/imagine');
const miCommand = require('./commands/mi');
const imageGenerateCommand = require('./commands/image-generate'); // Fixed variable name
const videoCommand = require('./commands/video');

// Global settings
global.packname = settings.packname;
global.author = settings.author;
global.channelLink = "https://whatsapp.com/channel/0029VbBGQu4C6ZvnH201CL0o";
global.ytch = "REDTECH XMD";
        ...
        switch (true) {
            ...
            case userMessage.startsWith('.move'):
                ...
                if (isNaN(position)) {
                    ...
                    handleTicTacToeMove(sock, chatId, senderId, position); // Fixed function name
                }
                break;
            ...
            case userMessage.startsWith('.fire'):
                ...
                break;
            case userMessage.startsWith('.incandescent'):
                await textmakerCommand(sock, chatId, message, userMessage, 'incandescent');
                break;
            case userMessage.startsWith('.gold'):
                await textmakerCommand(sock, chatId, message, userMessage, 'gold');
                break;
            case userMessage.startsWith('.purple2'):
                await textmakerCommand(sock, chatId, message, userMessage, 'purple2');
                break;
            case userMessage.startsWith('.thor'):
                await textmakerCommand(sock, chatId, message, userMessage, 'thor');
                break;
            case userMessage.startsWith('.lightglow'):
                await textmakerCommand(sock, chatId, message, userMessage, 'lightglow');
                break;
            case userMessage.startsWith('.cat'):
                await textmakerCommand(sock, chatId, message, userMessage, 'cat');
                break;
            case userMessage.startsWith('.whitegold'):
                await textmakerCommand(sock, chatId, message, userMessage, 'whitegold');
                break;
            case userMessage.startsWith('.harrypotter'):
                await textmakerCommand(sock, chatId, message, userMessage, 'harrypotter');
                break;
            case userMessage.startsWith('.transformer'):
                await textmakerCommand(sock, chatId, message, userMessage, 'transformer');
                break;
            case userMessage.startsWith('.water'):
                await textmakerCommand(sock, chatId, message, userMessage, 'water');
                break;
            case userMessage.startsWith('.devil2'):
                await textmakerCommand(sock, chatId, message, userMessage, 'devil2');
                break;
            case userMessage.startsWith('.greenneon'):
                await textmakerCommand(sock, chatId, message, userMessage, 'greenneon');
                break;
            case userMessage.startsWith('.wall'):
                await textmakerCommand(sock, chatId, message, userMessage, 'wall');
                break;
            case userMessage.startsWith('.neonlight'):
                await textmakerCommand(sock, chatId, message, userMessage, 'neonlight');
                break;
            ...
            case userMessage.startsWith('.dragonball'):
                ...
                break;
            case userMessage.startsWith('.didong'):
                await textmakerCommand(sock, chatId, message, userMessage, 'didong');
                break;
            ...
            case userMessage.startsWith('.tiktok') || userMessage.startsWith('.tt'):
                ...
                break;
            case userMessage.startsWith('.gpt') || userMessage.startsWith('.gemini') || userMessage.startsWith('.deepseek') || userMessage.startsWith('.openai'):
            ...
            case userMessage.startsWith('.ss') || userMessage.startsWith('.ssweb') || userMessage.startsWith('.screenshot'):
                ...
                break;
            case userMessage.startsWith('.galaxys5'):
                await handleGalaxys5Command(sock, chatId, message);
                break;
            case userMessage.startsWith('.iphone14promax'):
                await handleIphone14promaxCommand(sock, chatId, message);
                break;
            case userMessage.startsWith('.iphone12pro'):
                await handleIphone12proCommand(sock, chatId, message);
                break;
            case userMessage.startsWith('.iphoneX'):
                await handleIphoneXCommand(sock, chatId, message);
                break;
            case userMessage.startsWith('.iphone6plus'):
                await handleIphone6plusCommand(sock, chatId, message);
                break;
            case userMessage.startsWith('.iphone6'):
                await handleIphone6Command(sock, chatId, message);
                break;
            case userMessage.startsWith('.iphone5'):
                await handleIphone5Command(sock, chatId, message);
                break;
            case userMessage.startsWith('.maxage'):
                await handleMaxageCommand(sock, chatId, message);
                break;
            ...
            case userMessage.startsWith('.imagine') || userMessage.startsWith('.flux') || userMessage.startsWith('.dalle'):
                ...
                break;
            case userMessage.startsWith('.mi'):
                await miCommand(sock, chatId, message);
                break;
            case userMessage.startsWith('.image-generate'):
                await imageGenerateCommand(sock, chatId, message); // Fixed to use imageGenerateCommand
                break;
...
async function handleGroupParticipantUpdate(sock, update) {
    try {
        ...
        if (action === 'add') {
            ...
            const channelId = welcomeData?.channelId || '120363419447259737@newsletter';
        ...
        if (action === 'remove') {
            ...
            const channelId = goodbyeData?.channelId || '120363419447259737@newsletter';
